package com.tidecc.shiro.chapter03;
...
public class PermissionTest extends BaseTest {
    ...
    public void testIsPermitted() {
        login("classpath:com/tidecc/shiro/chapter03/shiro-permission.ini", "zhang", "123");
        //判断拥有权限：user:create
    ...
    public void testWildcardPermission1() {
        login("classpath:com/tidecc/shiro/chapter03/shiro-permission.ini", "li", "123");
